export const programs = [
  {
    ...
    code: `CREATE TABLE Customers ( CustomerID INT PRIMARY KEY, CustomerName VARCHAR(50), City VARCHAR(50), Country VARCHAR(50), Age INT );
...
4 rows in set (0.00 sec)`
  },
  {
    ...
    code: `SELECT * FROM Customers WHERE Country = 'India';
`,
...
4 rows in set (0.00 sec)`
  },
  {
    ...
    code: `SELECT * FROM Customers WHERE Age > 25 AND City = 'Delhi';
`,
...
1 row in set (0.00 sec)`
  },
  {
    ...
    code: `SELECT * FROM Employees WHERE Department = 'HR' OR Department = 'IT';
`,
...
5 rows in set (0.00 sec)`
  },
  {
    ...
    code: `SELECT * FROM Customers WHERE Country != 'USA';
`,
...
8 rows in set (0.00 sec)`
  },
  {
    ...
    code: `SELECT * FROM Customers ORDER BY Country ASC, CustomerName ASC;
`,
...
8 rows in set (0.00 sec)`
  },
  {
    ...
    code: `INSERT INTO Customers VALUES (9, 'Neha Patel', 'Pune', 'India', 26);
...
1 row in set (0.00 sec)`
  },
  {
    ...
    code: `UPDATE Employees SET Salary = Salary + (Salary * 0.10) WHERE Department = 'IT';
...
3 rows in set (0.00 sec)`
  },
  {
    ...
    code: `SELECT MIN(Salary) AS Minimum_Salary FROM Employees;
...
3 rows in set (0.00 sec)`
  },
  {
    ...
    code: `SELECT c.CustomerName, o.Amount 
FROM Customers c 
